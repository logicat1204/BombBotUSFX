...
AJefeFinal::AJefeFinal()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterial> MaterialJefe(TEXT("/Script/Engine.Material'/Game/AlvaroAssets/FinalBoss/tentacle-robot/source/Material_010.Material_010'"));
