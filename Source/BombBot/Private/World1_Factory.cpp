...
// Sets default values
AWorld1_Factory::AWorld1_Factory()
{
...
void AWorld1_Factory::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AWorld1_Factory::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AWorld1_Factory::CreateMap()
{
...
void AWorld1_Factory::CreateTerrain()
{
...
void AWorld1_Factory::CreateEnemy(int32 CantidadEnemigos)
{
...
void AWorld1_Factory::CreatePowerUps(int32 CantidadPowerUps)
{
	// Buscar todas las posiciones libres (valor 0)
	TArray<FIntPoint> PosicionesLibres;
	for (int32 i = 0; i < MapaCompleto.Num(); i++)
...
void AWorld1_Factory::CreatePortals()
{
}

void AWorld1_Factory::StartPosition()
{
...
TArray<TArray<int32>> AWorld1_Factory::FullMap(TArray<TArray<int32>> MapaInicial) {
...
void AWorld1_Factory::CreateBlocks(TArray<TArray<int32>> FullMap, int32 Altura)
{
